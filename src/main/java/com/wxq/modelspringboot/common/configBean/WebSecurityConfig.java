...
import com.wxq.modelspringboot.common.filter.AfterCsrfFilter;
import com.wxq.modelspringboot.common.filter.BeforeLoginFilter;
import com.wxq.modelspringboot.common.filter.qq.QQAuthenticationFilter;
import com.wxq.modelspringboot.common.filter.qq.QQAuthenticationManager;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .formLogin().loginPage("/login").defaultSuccessUrl("/user/dashboard")
                .and()
